...
*/
/**
 * Do not use the databases declared here (this should not declare any!).
 * Instead, include db.settings.php, which is git-ignored for security.
 */
...
/**
 * Add below any configuration that applies to all instances of the project.
 * For site-specific (development/staging/production), use other provided files.
 */

/*
 * Installed profile will appear below when installed with drush.
 * DO NOT COMMIT this file if only next line has been duplicated.
 */
